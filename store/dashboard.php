...
<head>
    ...
    <title>Dashboard - Ign0r3.com</title>
...
<header>
	...
	<h1>Dashboard for Ign0r3.com/store</h1>
...
<body>
	...
	<div class="Dashwelcomes">
		<p style="color:black">Hey, <?php echo $_SESSION['first']; ?>!</p>
		<p style="color:black">You are now on the user dashboard page.</p>
	</div>
		
	<div class="Dashinfos">
		<p style="color:black">Username: <?php echo $_SESSION['username']; ?><p>
		<p style="color:black">First name: <?php echo $_SESSION['first']; ?><p>
		<p style="color:black">Second name: <?php echo $_SESSION['second']; ?><p>
		<p style="color:black">Email: <?php echo $_SESSION['email']; ?><p>
		<p style="color:black">DOB: <?php echo $_SESSION['dob']; ?><p>
		<p style="color:black">Street: <?php echo $_SESSION['street']; ?><p>
		<p style="color:black">Postcode: <?php echo $_SESSION['postcode']; ?><p>
		
		<p style="color:black"><a href="orders.php">My orders</a></p>
